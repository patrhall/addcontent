...
{
    public abstract class AimUsers : PageBase
    {
        protected AIM.Business.AimUsers.DataObjectsDataContext db = new AIM.Business.AimUsers.DataObjectsDataContext(AIM.Business.DataManager.ConnectionString);

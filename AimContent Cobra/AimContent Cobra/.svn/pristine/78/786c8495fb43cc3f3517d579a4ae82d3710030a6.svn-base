...
namespace AIM.Business.AimBusiness.Mekpoint.Website.AimContent
{
    ...
    partial void Deleteaspnet_Application(aspnet_Application instance);
		...
		public DataObjectsDataContext() : 
				base(global::AIM.Business.Properties.Settings.Default.AimContentConnectionString3, mappingSource)
		{
			OnCreated();
		}
